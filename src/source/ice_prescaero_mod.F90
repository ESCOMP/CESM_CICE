...
subroutine ice_prescaero_init2(compid, mpicom, gsmap, dom)
...
subroutine ice_prescaero_run(mDateIn, secIn, mpicom)
...
!EOP
   ...
   call shr_strdata_advance(sdat,mDateIn,SecIn,mpicom,'cice_paero')
